...
# Calculate the correlation matrix for the new results DataFrame
correlation_matrix = new_results_df.corr()

# Display the correlation matrix
print("\nCorrelation Matrix for the New Results DataFrame:")
print(correlation_matrix)

# Save the correlation matrix to a CSV file
correlation_output_path = r"C:\Users\ENG. JMK\OneDrive\Desktop\SEISMIC ANALYSIS\correlation_matrix.csv"
